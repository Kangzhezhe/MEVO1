...
def _request_one(
    ...
    # Smoke配置使用确定性的本地结构响应，只验证正式数据契约，不模拟语义质量。
    if str(config.get("teacher", {}).get("provider", "")) == "mock":
            ...
            "traces": [
                {
                    ...
                    "evidence_ids": evidence_ids,
                    "edit_reason": "The visible history supports a similar concise presentation.",
                    "edit_action": "Revise the parent into a concise task-focused output.",
                }
