...
def train(config: dict, max_steps_override: int | None = None) -> dict[str, Any]:
    ...
    arguments = TrainingArguments(
        ...
        save_steps=1 if max_steps > 0 else 500,
    ...
    report = {
        "protocol": {
            "output_only": "s0_output_only_global_editor_qwen_lora_v1",
            "gold_aware_trace": "s1_free_trace_global_editor_qwen_lora_v1",
            "atomic_trace": "s2_atomic_trace_global_editor_qwen_lora_v1",
            "conditional_preference_trace": "conditional_preference_global_editor_qwen_lora_v1",
            "simple_conditional_trace": "top8_simple_conditional_global_editor_qwen_lora_v1",
        }.get(str(config["sft_data"].get("supervision_mode")), "global_editor_qwen_lora_v1"),
